import { loadElevationData, destroyChart } from './elevation.js';
...
routeDirections.on('routeCalculated', (geojson) => {
    loadElevationData(geojson.properties.mode, geojson.properties.units, routeDirections, apiKey);
...
function printInstructions() {
    let prtContent = document.getElementById("instructions");
    let printWindow = window.open('', '', 'left=0,top=0,width=1200,height=600,toolbar=0,scrollbars=0,status=0');
